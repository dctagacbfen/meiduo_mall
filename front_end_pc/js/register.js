var vm = new Vue({
	...
	data: {
		...
		image_code_id: '', // uuid
		image_code_url: '', // 访问后端验证码视图的地址

        sending_flag: false, // 是否正在发送短信的标记
        sms_code_tip: '获取短信验证码', // 获取短信验证码标签占位文字
        error_image_code_message: '', // 短信验证码错误提示

        error_name_message: '', // 用户名输入框的提示
        error_phone_message: '', // 手机号输入框提示
