...
# /home/python/Desktop/meiduo_mall/meiduo_mall/meiduo_mall
print(BASE_DIR)
...
CRONJOBS = [
    # 每5分钟执行一次生成主页静态文件
    ('*/2 * * * *', 'contents.crons.generate_static_index_html', '>> /home/python/Desktop/meiduo_mall/meiduo_mall/logs/crontab.log')
]
